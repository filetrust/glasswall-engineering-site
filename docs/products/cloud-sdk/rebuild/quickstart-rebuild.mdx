...
A key is required to access the Glasswlal Rebuild API, one can be purchased [here](https://glasswall-store.com/collections/saas/products/file-rebuild)
...
A known good file for executing the request can be downloaded [here](/examples/Rebuild_Example_Image_That_Rebuilds.bmp)  
